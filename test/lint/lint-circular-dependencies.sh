...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "consensus/tx_verify -> esperanza/finalizationstate -> validation -> consensus/tx_verify"
    "core_io -> script/sign -> policy/policy -> validation -> core_io"
    "esperanza/checks -> esperanza/finalizationstate -> esperanza/checks"
    "esperanza/checks -> txmempool -> esperanza/checks"
    "esperanza/checks -> validation -> esperanza/checks"
    "esperanza/finalizationstate -> validation -> esperanza/finalizationstate"
    "esperanza/finalizationstate -> validation -> finalization/vote_recorder -> esperanza/finalizationstate"
    "esperanza/vote -> keystore -> script/script -> esperanza/vote"
    "esperanza/vote -> keystore -> script/sign -> policy/policy -> validation -> finalization/vote_recorder -> esperanza/vote"
