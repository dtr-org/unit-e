...
def main():
    ...
    tmpdir = "%s/unite_test_runner_%s" % (args.tmpdirprefix, datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))
    os.makedirs(tmpdir)
    ...
    test_list = ['finalization_state_restoration.py', 'feature_reindex_commits.py'] * 50
