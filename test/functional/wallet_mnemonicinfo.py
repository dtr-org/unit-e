...
class WalletMnemonicinfoTest(UnitETestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(info['bip39_seed'],
                     '5435cb4a230f79d09b9b6b9bc90d773255b2f6a572d2cfe62e90e7a23e4c23b2aea7b980584ee2dbc28f0af26f504486d2f3184398e280c6bf8e207b035bd305')
        assert_equal(info['bip32_root'],
    ...
    # test vectors as per https://github.com/trezor/python-mnemonic/blob/master/vectors.json
    _test_vectors = [
        [
