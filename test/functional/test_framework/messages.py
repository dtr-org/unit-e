...
"""UnitE test framework primitive and message strcutures
...
class CBlock(CBlockHeader):
    ...
    def calc_witness_merkle_root(self):
        # For witness root purposes, the hash of the coinbase, with witness, is
        # defined to be 0...0
...
class P2PHeaderAndShortIDs:
    ...
    def __repr__(self):
        return (
            ...
            (repr(self.header), self.nonce, self.shortids_length, repr(self.shortids), self.prefilled_txn_length, repr(self.prefilled_txn))
        )
