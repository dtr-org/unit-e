 ...
 */
#ifndef UNITE_UTIL_SYSTEM_H
#define UNITE_UTIL_SYSTEM_H
...
/**
 * There was a translation function.
 * It has been deleted since we're using separate wallet app.
 */
