...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case UNT: return QString("Bitcoins");
    case mUNT: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uUNT: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
