    ...
    mapper(0)
{
    ...
    ui->uniteAtStartup->setToolTip(ui->uniteAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->uniteAtStartup->setText(ui->uniteAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openUnitEConfButton->setToolTip(ui->openUnitEConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new UnitEUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->uniteAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openUnitEConfButton_clicked()
{
