...
OptionsDialog::OptionsDialog(QWidget *parent, bool enableWallet)
  ...
  ui->uniteAtStartup->setToolTip(
      ui->uniteAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
  ui->uniteAtStartup->setText(ui->uniteAtStartup->text().arg(tr(PACKAGE_NAME)));

  ui->openUnitEConfButton->setToolTip(
      ui->openUnitEConfButton->toolTip().arg(tr(PACKAGE_NAME)));
