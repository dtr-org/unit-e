...
class TxViewDelegate : public QAbstractItemDelegate {
 ...
 public:
  ...
  inline void paint(QPainter *painter, const QStyleOptionViewItem &option,
    ...
    painter->setPen(foreground);
    QString amountText = UnitEUnits::formatWithUnit(
        unit, amount, true, UnitEUnits::separatorAlways);
    if (!confirmed) {
...
void OverviewPage::setBalance(const CAmount &balance,
  ...
  ui->labelBalance->setText(UnitEUnits::formatWithUnit(
      unit, balance, false, UnitEUnits::separatorAlways));
  ui->labelUnconfirmed->setText(UnitEUnits::formatWithUnit(
      unit, unconfirmedBalance, false, UnitEUnits::separatorAlways));
  ui->labelImmature->setText(UnitEUnits::formatWithUnit(
      unit, immatureBalance, false, UnitEUnits::separatorAlways));
  ui->labelTotal->setText(UnitEUnits::formatWithUnit(
      unit, balance + unconfirmedBalance + immatureBalance, false,
      UnitEUnits::separatorAlways));
  ui->labelWatchAvailable->setText(UnitEUnits::formatWithUnit(
      unit, watchOnlyBalance, false, UnitEUnits::separatorAlways));
  ui->labelWatchPending->setText(UnitEUnits::formatWithUnit(
      unit, watchUnconfBalance, false, UnitEUnits::separatorAlways));
  ui->labelWatchImmature->setText(UnitEUnits::formatWithUnit(
      unit, watchImmatureBalance, false, UnitEUnits::separatorAlways));
  ui->labelWatchTotal->setText(UnitEUnits::formatWithUnit(
