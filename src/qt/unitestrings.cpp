...
static const char UNUSED *unite_strings[] = {
    ...
    QT_TRANSLATE_NOOP("unite-core",
                      "Error creating %s: You can't create non-HD wallets with "
                      "this version."),
    ...
    QT_TRANSLATE_NOOP("unite-core",
                      "Error loading %s: You can't disable HD on an already "
                      "existing HD wallet"),
    ...
    QT_TRANSLATE_NOOP("unite-core",
                      "Listen for JSON-RPC connections on <port> (default: %u "
                      "or testnet: %u)"),
    QT_TRANSLATE_NOOP(
        "unite-core",
    ...
    QT_TRANSLATE_NOOP("unite-core",
                      "Reducing -maxconnections from %d to %d, because of "
                      "system limitations."),
    QT_TRANSLATE_NOOP("unite-core",
