...
void OptionsModel::Init(bool resetSettings) {
  ...
  if (!settings.contains("nDisplayUnit"))
    settings.setValue("nDisplayUnit", UnitEUnits::UNT);
  ...
  // overridden by command-line and show this in the UI.
...
void OptionsModel::checkAndMigrate() {
  ...
  if (settingsVersion < CLIENT_VERSION) {
    ...
    // see https://github.com/unite/unite/pull/8273
  ...
  // Overwrite the 'addrSeparateProxyTor' setting in case it has been set to an
  // illegal default value (see issue #12623; PR #12650).
  if (settings.contains("addrSeparateProxyTor") &&
