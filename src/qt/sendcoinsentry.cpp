...
SendCoinsEntry::SendCoinsEntry(const PlatformStyle *_platformStyle,
  ...
  // normal unite address field
  GUIUtil::setupAddressWidget(ui->payTo, this);
  // just a label for displaying unite address(es)
...
void SendCoinsEntry::setValue(const SendCoinsRecipient &value) {
  ...
  } else  // normal payment
  {
    ...
    if (!recipient.label
             .isEmpty())  // if a label had been set from the addressbook, don't
                          // overwrite with an empty label
