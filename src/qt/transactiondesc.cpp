...
QString TransactionDesc::toHTML(CWallet* wallet, CWalletTx& wtx,
  ...
  if (wtx.IsCoinBase() && nCredit == 0) {
    ...
    if (wtx.IsInMainChain())
      strHTML +=
          UnitEUnits::formatHtmlWithUnit(unit, nUnmatured) + " (" +
    ...
    //
    strHTML += "<b>" + tr("Credit") + ":</b> " +
               UnitEUnits::formatHtmlWithUnit(unit, nNet) + "<br>";
  } else {
    ...
    if (fAllFromMe) {
      ...
      for (const CTxOut& txout : wtx.tx->vout) {
        ...
        strHTML += "<b>" + tr("Debit") + ":</b> " +
                   UnitEUnits::formatHtmlWithUnit(unit, -txout.nValue) + "<br>";
        if (toSelf)
          strHTML += "<b>" + tr("Credit") + ":</b> " +
                     UnitEUnits::formatHtmlWithUnit(unit, txout.nValue) +
                     "<br>";
      }
      ...
      if (fAllToMe) {
        ...
        strHTML += "<b>" + tr("Total debit") + ":</b> " +
                   UnitEUnits::formatHtmlWithUnit(unit, -nValue) + "<br>";
      ...
      if (nTxFee > 0)
        strHTML += "<b>" + tr("Transaction fee") + ":</b> " +
                   UnitEUnits::formatHtmlWithUnit(unit, -nTxFee) + "<br>";
    } else {
      //
  ...
  strHTML += "<b>" + tr("Net amount") + ":</b> " +
             UnitEUnits::formatHtmlWithUnit(unit, nNet, true) + "<br>";
      ...
      if (pcoinsTip->GetCoin(prevout, prev)) {
        {
          ...
          strHTML = strHTML + " " + tr("Amount") + "=" +
                    UnitEUnits::formatHtmlWithUnit(unit, vout.nValue);
