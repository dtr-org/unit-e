...
#ifndef UNITE_QT_RPCCONSOLE_H
#define UNITE_QT_RPCCONSOLE_H
...
class RPCConsole : public QWidget {
 ...
 public:
  ...
  static bool RPCExecuteCommandLine(
      std::string &strResult, const std::string &strCommand,
      std::string *const pstrFilteredOut = nullptr) {
