...
AskPassphraseDialog::AskPassphraseDialog(Mode _mode, QWidget *parent)
  ...
  switch (mode) {
    ...
    case Decrypt:  // Ask passphrase
      ui->warningLabel->setText(
          tr("This operation needs your wallet passphrase to decrypt the "
             "wallet."));
      ui->passLabel2->hide();
      ui->passEdit2->hide();
      ui->passLabel3->hide();
...
void AskPassphraseDialog::accept() {
  ...
  // SecureString::operator=(std::string) Alternately, find a way to make this
  // input mlock()'d to begin with.
  ...
  switch (mode) {
    case Encrypt: {
      ...
      QMessageBox::StandardButton retval = QMessageBox::question(
          ...
          tr("Warning: If you encrypt your wallet and lose your passphrase, "
             "you will <b>LOSE ALL OF YOUR UNITES</b>!") +
            ...
            QMessageBox::warning(
                ...
                "<qt>" +
                    tr("%1 will close now to finish the encryption process. "
                       ...
                       "protect "
                       "your unites from being stolen by malware infecting "
                       "your computer.")
                        .arg(tr(PACKAGE_NAME)) +
                    "<br><br><b>" +
                    tr("IMPORTANT: Any previous backups you have made of your "
                       ...
                       "will become useless as soon as you start using the "
