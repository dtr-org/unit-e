...
/**
  UnitE GUI main class. This class represents the main window of the UnitE UI.
...
class UnitEGUI : public QMainWindow {
 ...
 public:
  ...
  explicit UnitEGUI(const PlatformStyle *platformStyle,
  ...
  */
  ...
  /** Set the wallet model.
      The wallet model represents a unite wallet, and offers access to the list
     of transactions, address book and sending functionality.
  */
