...
void PaymentServerTests::paymentServerTests() {
  ...
  // for uninitialized payment requests and that will fail our test here.
  ...
  // int64_t): 9223372036854775807 (uint64), 9223372036854775807 (int64_t) and
  // -1 (int32_t) -1 is 1969-12-31 23:59:59 (for a 32 bit time values)
  ...
  // int64_t, allowed uint64): 9223372036854775808 (uint64),
  // -9223372036854775808 (int64_t) and 0 (int32_t) 0 is 1970-01-01 00:00:00
  // (for a 32 bit time values)
  ...
  // Payment request with amount overflow (amount is set to 21000001 UNT):
