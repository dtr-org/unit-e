...
class FinalizationState {
 public:
  ...
  Result ValidateVote(const VoteData& vote) const;
  void ProcessVote(const VoteData& vote);
  ...
  Result IsSlashable(VoteData& vote1, VoteData& vote2) const;
  void ProcessSlash(const VoteData& vote1, const VoteData& vote2, CAmount& slashingBountyOut);
  ...
  VoteData GetRecommendedVote(const uint256& validatorIndex) const;
