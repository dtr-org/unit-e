...
bool ParseFinalizationParams(std::string jsonString, FinalizationParams &paramsOut) {
  ...
  paramsOut.m_baseInterestFactor = ufp64::to_ufp64((uint64_t) baseInterestFactor);
  ...
  paramsOut.m_basePenaltyFactor = ufp64::div_2uint((uint64_t) basePenaltyFactor, 10000000);
  return true;
}
