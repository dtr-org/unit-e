...
class CInputCoin {
 public:
  CInputCoin(const CWalletTx* walletTx, unsigned int i) {
    if (!walletTx) throw std::invalid_argument("walletTx should not be null");
...
class CWallet final : public CCryptoKeyStore, public CValidationInterface {
 private:
  ...
  esperanza::walletext::StakingWalletExtension m_stakingExtension =
      esperanza::walletext::StakingWalletExtension(this);
 ...
 public:
  ...
  std::set<CTxDestination> GetAccountAddresses(
