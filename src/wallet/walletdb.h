 ...
 * scope. Optionally (on by default) it will flush to disk as well.
 */
class CWalletDB {
 private:
 ...
 public:
  ...
  /// cached accounting entries! Use wallet.AddAccountingEntry instead, to write
  /// *and* update its caches.
