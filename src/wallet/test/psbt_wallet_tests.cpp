...
BOOST_AUTO_TEST_CASE(psbt_updater_test)
{
    ...
    s_prev_tx1 >> prev_tx1;
    CWalletTx prev_wtx1(m_wallet.get(), prev_tx1);
    ...
    s_prev_tx2 >> prev_tx2;
    CWalletTx prev_wtx2(m_wallet.get(), prev_tx2);
    ...
    // Add hd seed
    CKey key = DecodeSecret("93D4t8w1xtKQuZC6pu7MAMdp9344Qmo6GTD152VGqoaQzF5veoL"); // Testnet and uncompressed form of cUkG8i1RFfWGWy5ziR11zJ5V4U4W3viSFCfyJmZnvQaUsd1xuF3T
    ...
    bool complete = true;
    BOOST_REQUIRE_EQUAL(TransactionError::OK, FillPSBT(m_wallet.get(), psbtx, complete, SIGHASH_ALL, false, true));
