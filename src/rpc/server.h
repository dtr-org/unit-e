...
#ifndef UNITE_RPCSERVER_H
#define UNITE_RPCSERVER_H
...
class RPCTimerInterface {
 public:
   ...
   * implementations of timers. This is needed to cope with the case in which
   * there is no HTTP server, but only GUI RPC console, and to break the
   * dependency of pcserver on httprpc.
   */
...
class CRPCTable {
 ...
 public:
   ...
   * protection). Commands cannot be overwritten (returns false).
   */
