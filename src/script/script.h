...
public:
    ...
    /**
     * Pre-version-0.6, UnitE always counted CHECKMULTISIGs
    ...
    bool IsPayToPublicKeySha256() const;
    ...
    static bool SplitRemoteStakingScript(const CScript &script, CScript &staking_script, CScript &spending_script);
