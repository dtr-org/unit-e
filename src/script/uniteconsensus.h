...
#ifndef UNITE_UNITECONSENSUS_H
#define UNITE_UNITECONSENSUS_H
...
enum {
  ...
  uniteconsensus_SCRIPT_FLAGS_VERIFY_P2SH =
      (1U << 0),  // evaluate P2SH (BIP16) subscripts
  uniteconsensus_SCRIPT_FLAGS_VERIFY_DERSIG =
      (1U << 2),  // enforce strict DER (BIP66) compliance
  uniteconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY =
      (1U << 4),  // enforce NULLDUMMY (BIP147)
  uniteconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY =
      (1U << 9),  // enable CHECKLOCKTIMEVERIFY (BIP65)
  uniteconsensus_SCRIPT_FLAGS_VERIFY_CHECKSEQUENCEVERIFY =
      (1U << 10),  // enable CHECKSEQUENCEVERIFY (BIP112)
  uniteconsensus_SCRIPT_FLAGS_VERIFY_WITNESS =
      (1U << 11),  // enable WITNESS (BIP141)
  uniteconsensus_SCRIPT_FLAGS_VERIFY_ALL =
      uniteconsensus_SCRIPT_FLAGS_VERIFY_P2SH |
      uniteconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |
      uniteconsensus_SCRIPT_FLAGS_VERIFY_NULLDUMMY |
      uniteconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
...
EXPORT_SYMBOL int uniteconsensus_verify_script(
    ...
    unsigned int flags, uniteconsensus_error *err);

EXPORT_SYMBOL int uniteconsensus_verify_script_with_amount(
    const unsigned char *scriptPubKey, unsigned int scriptPubKeyLen,
