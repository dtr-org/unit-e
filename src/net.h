...
class CNode {
 ...
 public:
  ...
  // is intended to be printed out, displayed to humans in various forms and so
  // on. So we sanitize it and store the sanitized version in cleanSubVer. The
  // original should be used when dealing with the network or wire types and the
  // cleaned string used when displayed or logged.
  ...
  // message b) the peer may tell us in its version message that we should not
  // relay tx invs
