...
static std::map<std::string, unsigned int> mapFlagNames = {
    ...
    {std::string("CONST_SCRIPTCODE"),
     (unsigned int)SCRIPT_VERIFY_CONST_SCRIPTCODE},
};
...
BOOST_AUTO_TEST_CASE(test_IsStandard) {
  ...
  t.vout[0].scriptPubKey = CScript()
                           << OP_RETURN
                           << ParseHex(
                                  "04678afdb0fe5548271967f1a67130b7105cd6a828e0"
                                  "3909a67962e0ea1f61deb649f6bc3f4cef38");
