...
BOOST_AUTO_TEST_CASE(parse_params_values)
{
    ...
    BOOST_CHECK_EQUAL(result.m_slashFractionMultiplier, defaultParams.m_slashFractionMultiplier);
    BOOST_CHECK_EQUAL(result.m_bountyFractionDenominator, bountyFractionDenominator);
    BOOST_CHECK_EQUAL(result.m_baseInterestFactor, baseInterestFactor);
    BOOST_CHECK_EQUAL(result.m_basePenaltyFactor, defaultParams.m_basePenaltyFactor);
}
