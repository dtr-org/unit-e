...
/** Retrieve a transaction and the header of the block it is contained in (form
 * memory pool if possible, otherwise form disk). */
bool GetTransactionAndBlockHeader(const uint256& hash,
