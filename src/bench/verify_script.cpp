...
static CMutableTransaction BuildCreditingTransaction(
...
static CMutableTransaction BuildSpendingTransaction(
    const CScript& scriptSig, const CMutableTransaction& txCredit) {
