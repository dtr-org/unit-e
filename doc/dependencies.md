...
These are the dependencies currently used by UnitE Core. You can find instructions for installing them in the `build-*.md` file for your platform.

| Dependency | Version used | Minimum required | CVEs | Shared | [Bundled Qt library](https://doc.qt.io/qt-5/configure-options.html) |
| --- | --- | --- | --- | --- | --- |
| Berkeley DB | [4.8.30](http://www.oracle.com/technetwork/database/database-technologies/berkeleydb/downloads/index.html) | 4.8.x | No |  |  |
| Boost | [1.64.0](http://www.boost.org/users/download/) | [1.47.0](https://github.com/unite/unite/pull/8920) | No |  |  |
...
| PCRE |  |  |  |  | [Yes](https://github.com/unite/unite/blob/master/depends/packages/qt.mk#L76) |
...
| XCB |  |  |  |  | [Yes](https://github.com/unite/unite/blob/master/depends/packages/qt.mk#L94) (Linux only) |
| xkbcommon |  |  |  |  | [Yes](https://github.com/unite/unite/blob/master/depends/packages/qt.mk#L93) (Linux only) |
