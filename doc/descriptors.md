# Support for Output Descriptors in UnitE Core

Since UnitE Core v0.17, there is support for Output Descriptors in the
...
on UnitE's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing UnitE Core wallets, a convenience function `combo` is
