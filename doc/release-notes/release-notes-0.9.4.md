UnitE Core version 0.9.4 is now available from:

  https://unite.org/bin/0.9.4/
...
this update is incompatible with the UnitE system and could lead to consensus
forks.

UnitE Core released binaries from https://unite.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~unite/+archive/ubuntu/unite
- A third-party or self-compiled UnitE Core

upgrade to UnitE Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
