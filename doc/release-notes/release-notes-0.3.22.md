Download URL: https://sourceforge.net/projects/unite/files/UnitE/unite-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 UTE fee schedule (users still pay 0.01 UTE per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #unite00 - #unite99
