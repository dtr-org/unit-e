UnitE Core version 0.14.1 is now available from:

  <https://unite.org/bin/unite-core-0.14.1/>
...
here:
[reducing-united-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` unite-tx input verification (awemany, jnewbery)
