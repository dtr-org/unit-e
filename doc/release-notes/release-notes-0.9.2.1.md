UnitE Core version 0.9.2.1 is now available from:

  https://unite.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 UNT to 0.01 UNT
...
- Fix "Start unite on system login"
