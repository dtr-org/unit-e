UnitE Core version 0.13.2 is now available from:

  <https://unite.org/bin/unite-core-0.13.2/>
...
- #8908 `4a974b2` Update unite-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow unite-tx to create v2 transactions (btcdrak)
