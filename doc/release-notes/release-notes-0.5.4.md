UnitE version 0.5.4 is now available for download at:
http://sourceforge.net/projects/unite/files/UnitE/unite-0.5.4/
...
http://gitorious.org/unite/united-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix UnitE-Qt notifications under Growl 1.3.
Increase required age of UnitE-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxUnitE properly when installing UnitE-Qt over it. (Windows)
