UnitE Core version 0.10.4 is now available from:

  <https://unite.org/bin/unite-core-0.10.4/>
...
- #6953 `43c2789` Split unite-tx into its own package
- #6953 `dfe0d4d` Include unite-tx binary on Debian/Ubuntu
