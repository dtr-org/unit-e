UnitE-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/unite/files/UnitE/unite-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the UnitE
...
New/changed settings (command-line or unite.conf file)
--------------------------------------------------------
