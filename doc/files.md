...
unit-e.conf        | contains configuration settings for unit-e or bitcoin-qt
...
debug.log           | contains debug information and general logging generated by unit-e or bitcoin-qt
