...
- [Development guidelines](#development-guidelines)
    - [General UnitE Core](#general-unite-core)
    - [Wallet](#wallet)
    - [General C++](#general-c)
...
UnitE Core is a multi-threaded application, and deadlocks or other
...
UnitE Core can be compiled with various "sanitizers" enabled, which add
...
file descriptors it will cause problems with UnitE's `select()` loop, because
...
compatibility between nodes. This happened in UnitE 0.8 (when LevelDB was
...
would be to revert the upstream fix before applying the updates to UnitE's
